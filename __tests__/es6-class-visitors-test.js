...
describe('es6-classes', function() {
  ...
  describe('ClassDeclarations', function() {
    ...
    describe('functional tests', function() {
      ...
      it('consistently does not munge private property identifiers', function() {
        var code = transform([
          'class Foo {',
          '  constructor(p1) {',
          '    this._p1 = p1;',
      ...
      it('stores would be munged private properties on the instance', function() {
      ...
      it('consistently does not munge nested private property identifiers', function() {
        var code = transform([
          'class Foo {',
          '  constructor(p1) {',
          '    this._data = {_p1: null};',
        ...
        var fooInst = new Foo('a');
        expect(fooInst.getData()._p1).toBe('a');
        expect(fooInst.getP1()).toBe('a');
      });

      it('consistently does not munge private method identifiers', function() {
        var code = transform([
          'class Foo {',
          '  getBar() {',
          '    return this._getBar();',
        ...
        var fooInst = new Foo();
        expect(typeof fooInst._getBar).toBe('function');
        expect(fooInst.getBar()).toBe(42);
      });

      it('consistently does not munge private method params', function() {
        var code = transform([
          'class Foo {',
      ...
      it('consistently does not munge private idents in super call params', function() {
        var code = transform([
          'class Parent {',
          '  constructor(foo) {',
          '    this.foo = foo;',
      ...
      it('consistently does not munge private idents in nested funcs', function() {
        var code = transform([
          'class Foo {',
          '  bar(_p1, p2) {',
          '    return function(_a) {',
      ...
      it('does not munge properties of private vars declared out of scope', function() {
        var code = transform([
          'var _bar = {_private: 42}',
          'class Foo {',
          '  getOuterPrivate() {',
        ...
        expect(fooInst.getOuterPrivate()).toBe(42);
      });
      ...
      it('does not care about "private" properties when minify opt is set', function() {
        var code = transform([
          'class Foo {',
          '  constructor(p1) {',
          '    this._p1 = p1;',
        ...
        var fooInst = new Foo('a');
        expect(fooInst.$Foo0).toBe(undefined);
      });

      it('does not care about "private" methods when minify opt is set', function() {
        var code = transform([
          'class Foo {',
          '  _bar() {',
          '    return 42;',
        ...
        var fooInst = new Foo();
        expect(typeof fooInst.$Foo0).toBe('undefined');
      });

      it('does not munge child class different from parent in same file', function() {
        var code = transform([
          'class Parent {',
          '  setParentFoo(foo) {',
          '    this._foo = foo;',
        ...
        expect(childInst.getParentFoo()).toBe('child');
  ...
  describe('ClassExpressions', function() {
    ...
    describe('functional tests', function() {
      it('scopes each anonymous class separately', function() {
        ...
        var fooInst = new Foo();
        var barInst = new Bar();
        expect(fooInst.properties).toEqual(barInst.properties);
